t=0:0.002:1.51;		%vectorul timp cu rezolutia de 2 ms care se extinde pana la 1.51 s pentru a putea reprezenta tot semnalul
...
in=[-1 1 -3 3 -5 5];	%vectorul in contine amplitudinile fiecarui nivel
...
semnal=[y1 y2 y3 y4 y5 y6];	%se realizeaza vectorul semnal prin concatenare
